...
export function Module({ title, moduleIndex, amountOfLesson }: ModuleProps) {
    ...
    const lessons = useAppSelector((state) => state.player.courser.modules[moduleIndex].lessons)
